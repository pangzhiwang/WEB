...
const char* error_403_form = "You do not hane permission to get file from this server.\n";
...
void http_conn::init( int sockfd, const sockaddr_in& addr )
{
    m_sockfd = sockfd;
    m_address = addr;
    /* 下边两行是为了避免TIME_WAIT状态，仅用于调试，实际使用时应该去掉 */
    int reuse = 1;
...
/* 解析HTTP请求，获得请求方法、目标URL，以及HTTP版本号 */
...
http_conn::HTTP_CODE http_conn::parse_headers( char* text )
{
    ...
    if( text[0] == '\0' )
    {
        /* 如果HTTP请求有消息体，则还需读取m_content_length字节的消息体，状态机转移到CHECK_STATE_CONTENT状态 */
